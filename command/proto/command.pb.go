...
type CDCRow struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Fields        []*CDCValue            `protobuf:"bytes,1,rep,name=fields,proto3" json:"fields,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CDCRow) GetFields() []*CDCValue {
	if x != nil {
		return x.Fields
	}
	return nil
...
type CDCEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Op            CDCEvent_Operation     `protobuf:"varint,1,opt,name=op,proto3,enum=command.CDCEvent_Operation" json:"op,omitempty"`
	Table         string                 `protobuf:"bytes,2,opt,name=table,proto3" json:"table,omitempty"`
	OldRowId      int64                  `protobuf:"varint,3,opt,name=old_row_id,json=oldRowId,proto3" json:"old_row_id,omitempty"`
	NewRowId      int64                  `protobuf:"varint,4,opt,name=new_row_id,json=newRowId,proto3" json:"new_row_id,omitempty"`
	OldRaw        *CDCRow                `protobuf:"bytes,5,opt,name=old_raw,json=oldRaw,proto3" json:"old_raw,omitempty"`
	NewRow        *CDCRow                `protobuf:"bytes,6,opt,name=new_row,json=newRow,proto3" json:"new_row,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CDCEvent) GetOldRaw() *CDCRow {
	if x != nil {
		return x.OldRaw
	}
	return nil
...
var file_command_proto_rawDesc = []byte{
	...
	0x52, 0x6f, 0x77, 0x12, 0x29, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x43, 0x44,
	0x43, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x9b,
	0x02, 0x0a, 0x08, 0x43, 0x44, 0x43, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x02, 0x6f,
	0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x2e, 0x43, 0x44, 0x43, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x4f, 0x70, 0x65, 0x72, 0x61,
	...
	,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x03, 0x42, 0x2b, 0x5a, 0x29,
...
var file_command_proto_depIdxs = []int32{
	...
	22, // 13: command.CDCRow.fields:type_name -> command.CDCValue
	3,  // 14: command.CDCEvent.op:type_name -> command.CDCEvent.Operation
	23, // 15: command.CDCEvent.old_raw:type_name -> command.CDCRow
