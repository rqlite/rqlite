...
type CDCEvent struct {
	...
	OldRow        *CDCRow                `protobuf:"bytes,5,opt,name=old_row,json=oldRow,proto3" json:"old_row,omitempty"`
...
func (x *CDCEvent) GetOperation() OperationType {
	if x != nil {
		return x.Operation
	}
...
type UpdateHookEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OldRowId      int64                  `protobuf:"varint,1,opt,name=old_row_id,json=oldRowId,proto3" json:"old_row_id,omitempty"`
	NewRowId      int64                  `protobuf:"varint,2,opt,name=new_row_id,json=newRowId,proto3" json:"new_row_id,omitempty"`
	OldRow        *CDCRow                `protobuf:"bytes,3,opt,name=old_row,json=oldRow,proto3" json:"old_row,omitempty"`
	NewRow        *CDCRow                `protobuf:"bytes,4,opt,name=new_row,json=newRow,proto3" json:"new_row,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateHookEvent) GetOldRowId() int64 {
	if x != nil {
		return x.OldRowId
	}
	return 0
...
func (x *UpdateHookEvent) GetNewRowId() int64 {
	if x != nil {
		return x.NewRowId
	}
	return 0
...
func (x *UpdateHookEvent) GetOldRow() *CDCRow {
	if x != nil {
		return x.OldRow
	}
	return nil
...
func (x *UpdateHookEvent) GetNewRow() *CDCRow {
	if x != nil {
		return x.NewRow
	}
	return nil
...
const file_command_proto_rawDesc = "" +
	...
	"statements\x12\x1c\n" +
	"\tdbTimeout\x18\x03 \x01(\x03R\tdbTimeout\"\xad\x03\n" +
	"\fQueryRequest\x12*\n" +
	...
	"\x05value\"3\n" +
	"\x06CDCRow\x12)\n" +
	"\x06values\x18\x01 \x03(\v2\x11.command.CDCValueR\x06values\"\x8d\x02\n" +
	"\bCDCEvent\x124\n" +
	"\toperation\x18\x01 \x01(\x0e2\x16.command.OperationTypeR\toperation\x12\x1d\n" +
	"\n" +
	"table_name\x18\x02 \x01(\tR\ttableName\x12\x1c\n" +
	"\n" +
	"old_row_id\x18\x03 \x01(\x03R\boldRowId\x12\x1c\n" +
	"\n" +
	"new_row_id\x18\x04 \x01(\x03R\bnewRowId\x12(\n" +
	"\aold_row\x18\x05 \x01(\v2\x0f.command.CDCRowR\x06oldRow\x12(\n" +
	"\anew_row\x18\x06 \x01(\v2\x0f.command.CDCRowR\x06newRow\x12\x1c\n" +
	"\ttimestamp\x18\a \x01(\x03R\ttimestamp\"\xa1\x01\n" +
	"\x0fUpdateHookEvent\x12\x1c\n" +
	"\n" +
	"old_row_id\x18\x01 \x01(\x03R\boldRowId\x12\x1c\n" +
	"\n" +
	"new_row_id\x18\x02 \x01(\x03R\bnewRowId\x12(\n" +
	"\aold_row\x18\x03 \x01(\v2\x0f.command.CDCRowR\x06oldRow\x12(\n" +
	"\anew_row\x18\x04 \x01(\v2\x0f.command.CDCRowR\x06newRow*|\n" +
	...
	"\x15OPERATION_TYPE_DELETE\x10\x03B+Z)github.com/rqlite/rqlite/v8/command/protob\x06proto3"
...
var file_command_proto_goTypes = []any{
	(OperationType)(0),           // 0: command.OperationType
	(QueryRequest_Level)(0),      // 1: command.QueryRequest.Level
	...
	(*UpdateHookEvent)(nil),      // 25: command.UpdateHookEvent
}
var file_command_proto_depIdxs = []int32{
	...
	1,  // 3: command.QueryRequest.level:type_name -> command.QueryRequest.Level
	...
	1,  // 8: command.ExecuteQueryRequest.level:type_name -> command.QueryRequest.Level
	...
	0,  // 14: command.CDCEvent.operation:type_name -> command.OperationType
	23, // 15: command.CDCEvent.old_row:type_name -> command.CDCRow
	23, // 16: command.CDCEvent.new_row:type_name -> command.CDCRow
	23, // 17: command.UpdateHookEvent.old_row:type_name -> command.CDCRow
	23, // 18: command.UpdateHookEvent.new_row:type_name -> command.CDCRow
