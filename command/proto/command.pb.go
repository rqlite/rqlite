...
func (QueryRequest_Level) EnumDescriptor() ([]byte, []int) {
	return file_command_proto_command_proto_rawDescGZIP(), []int{3, 0}
}
...
func (BackupRequest_Format) EnumDescriptor() ([]byte, []int) {
	return file_command_proto_command_proto_rawDescGZIP(), []int{10, 0}
}
...
func (Command_Type) EnumDescriptor() ([]byte, []int) {
	return file_command_proto_command_proto_rawDescGZIP(), []int{17, 0}
}
...
var (
	...
	file_command_proto_command_proto_rawDescData = file_command_proto_command_proto_rawDesc
)

func file_command_proto_command_proto_rawDescGZIP() []byte {
	file_command_proto_command_proto_rawDescOnce.Do(func() {
		file_command_proto_command_proto_rawDescData = protoimpl.X.CompressGZIP(file_command_proto_command_proto_rawDescData)
	})
...
func file_command_proto_command_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_command_proto_command_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Values); i {
			case 0:
				return &v.state
			case 1:
		...
		file_command_proto_command_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_command_proto_command_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Noop); i {
			case 0:
				return &v.state
			case 1:
		...
		file_command_proto_command_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
	...
	file_command_proto_command_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Parameter_I)(nil),
		(*Parameter_D)(nil),
		(*Parameter_B)(nil),
		(*Parameter_Y)(nil),
	...
	file_command_proto_command_proto_msgTypes[9].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_command_proto_command_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_command_proto_command_proto_rawDesc = nil
