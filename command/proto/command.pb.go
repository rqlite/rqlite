...
const file_command_proto_rawDesc = "" +
	...
	"\x0frollbackOnError\x18\x04 \x01(\bR\x0frollbackOnError\"\xaa\x02\n" +
	"\fQueryRequest\x12*\n" +
	...
	"\x14linearizable_timeout\x18\x06 \x01(\x03R\x13linearizableTimeout\x12'\n" +
	"\x0fqualify_columns\x18\a \x01(\bR\x0equalifyColumns\"<\n" +
	"\x06Values\x122\n" +
	"\n" +
	...
	"\x04time\x18\x04 \x01(\x01R\x04time\"\xb1\x02\n" +
	...
	"\x10freshness_strict\x18\x05 \x01(\bR\x0ffreshnessStrict\x121\n" +
	"\x14linearizable_timeout\x18\x06 \x01(\x03R\x13linearizableTimeout\x12'\n" +
	"\x0fqualify_columns\x18\a \x01(\bR\x0equalifyColumns\"\x84\x01\n" +
