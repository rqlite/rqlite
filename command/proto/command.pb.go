...
func (x *BackupHeader) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *BackupHeader) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *BackupHeader) GetMd5Sum() []byte {
	if x != nil {
		return x.Md5Sum
	}
	return nil
...
var file_command_proto_rawDesc = []byte{
	...
	0x0c, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x18, 0x0a,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6d,
	0x64, 0x35, 0x73, 0x75, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x6d, 0x64, 0x35,
	0x73, 0x75, 0x6d, 0x22, 0xcc, 0x02, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12,
...
var file_command_proto_goTypes = []interface{}{
	...
	(*BackupHeader)(nil),         // 20: command.BackupHeader
