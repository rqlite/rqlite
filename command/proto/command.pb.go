...
func (x *Request) GetQualifyColumns() bool {
	if x != nil {
...
type ExecuteQueryResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Set when a statement succeeds through the write path. This is conservative:
	// no rows may have changed, or the transaction may subsequently be rolled back.
	Mutated bool `protobuf:"varint,4,opt,name=mutated,proto3" json:"mutated,omitempty"`
...
const file_command_proto_rawDesc = "" +
	...
	"\tfreshness\x18\x04 \x01(\x03R\tfreshness\x12)\n" +
	"\x10freshness_strict\x18\x05 \x01(\bR\x0ffreshnessStrict\x121\n" +
	"\x14linearizable_timeout\x18\x06 \x01(\x03R\x13linearizableTimeout\"\x9e\x01\n" +
	"\x14ExecuteQueryResponse\x12\x18\n" +
	"\amutated\x18\x04 \x01(\bR\amutated\x12\"\n" +
