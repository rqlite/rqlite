...
type LoadChunkRequest_Compression int32

const (
	LoadChunkRequest_LOAD_CHUNK_REQUEST_COMPRESSION_NONE   LoadChunkRequest_Compression = 0
	LoadChunkRequest_LOAD_CHUNK_REQUEST_COMPRESSION_GZIP   LoadChunkRequest_Compression = 1
	LoadChunkRequest_LOAD_CHUNK_REQUEST_COMPRESSION_SNAPPY LoadChunkRequest_Compression = 2
)

// Enum value maps for LoadChunkRequest_Compression.
var (
	LoadChunkRequest_Compression_name = map[int32]string{
		0: "LOAD_CHUNK_REQUEST_COMPRESSION_NONE",
		1: "LOAD_CHUNK_REQUEST_COMPRESSION_GZIP",
		2: "LOAD_CHUNK_REQUEST_COMPRESSION_SNAPPY",
	}
	LoadChunkRequest_Compression_value = map[string]int32{
		"LOAD_CHUNK_REQUEST_COMPRESSION_NONE":   0,
		"LOAD_CHUNK_REQUEST_COMPRESSION_GZIP":   1,
		"LOAD_CHUNK_REQUEST_COMPRESSION_SNAPPY": 2,
	}
)

func (x LoadChunkRequest_Compression) Enum() *LoadChunkRequest_Compression {
	p := new(LoadChunkRequest_Compression)
	*p = x
	return p
}

func (x LoadChunkRequest_Compression) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LoadChunkRequest_Compression) Descriptor() protoreflect.EnumDescriptor {
	return file_command_proto_enumTypes[2].Descriptor()
}

func (LoadChunkRequest_Compression) Type() protoreflect.EnumType {
	return &file_command_proto_enumTypes[2]
}

func (x LoadChunkRequest_Compression) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LoadChunkRequest_Compression.Descriptor instead.
func (LoadChunkRequest_Compression) EnumDescriptor() ([]byte, []int) {
...
type LoadChunkRequest struct {
	...
	Compression           LoadChunkRequest_Compression `protobuf:"varint,4,opt,name=compression,proto3,enum=command.LoadChunkRequest_Compression" json:"compression,omitempty"`
	TotalUncompressedSize int64                        `protobuf:"varint,5,opt,name=total_uncompressed_size,json=totalUncompressedSize,proto3" json:"total_uncompressed_size,omitempty"`
...
func (x *LoadChunkRequest) GetCompression() LoadChunkRequest_Compression {
	if x != nil {
		return x.Compression
	}
	return LoadChunkRequest_LOAD_CHUNK_REQUEST_COMPRESSION_NONE
}

func (x *LoadChunkRequest) GetTotalUncompressedSize() int64 {
	if x != nil {
...
var file_command_proto_rawDesc = []byte{
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xc9, 0x01, 0x0a, 0x0d, 0x42, 0x61, 0x63, 0x6b,
	...
	0x52, 0x06, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0x69, 0x0a, 0x06, 0x46, 0x6f, 0x72, 0x6d,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x8d, 0x03, 0x0a, 0x10, 0x4c, 0x6f, 0x61, 0x64, 0x43,
	...
	0x4c, 0x61, 0x73, 0x74, 0x12, 0x47, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x43, 0x48, 0x55, 0x4e, 0x4b, 0x10, 0x07, 0x42, 0x22, 0x5a, 0x20,
...
var file_command_proto_goTypes = []interface{}{
	...
	(LoadChunkRequest_Compression)(0), // 2: command.LoadChunkRequest.Compression
...
var file_command_proto_depIdxs = []int32{
	...
	2,  // 12: command.LoadChunkRequest.compression:type_name -> command.LoadChunkRequest.Compression
