...
Finally, if you're interested in understanding how distributed systems actually work, rqlite is a good example to study. Much thought has gone into its design and implementation, with clear seperation between the various components, including storage, distributed consensus, and API.
