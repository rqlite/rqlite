...
You could use rqlite as part of a larger system, as a central store for some critical relational data, without having to run larger, more complex [distributed databases](https://www.scaler.com/topics/dbms/distributed-database-in-dbms/).
