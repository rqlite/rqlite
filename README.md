 ...
 * SQLite dot-commands such as `.schema` or `.tables` are not currently handled. This is because those commands are features of the `sqlite3` command, not SQLite itself.
