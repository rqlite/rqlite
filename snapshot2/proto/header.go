...
// TotalSize returns the total size of the marshaled header andof all files described
// by the manifest. This is the number of bytes which needs to be read to obtain the
// manifest marshaled as bytes and all associated file data.
