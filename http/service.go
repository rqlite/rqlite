...
func ResetStats() {
	stats.Set(numLeaderNotFound, 0)
	stats.Set(numExecutions, 0)
	stats.Set(numQueuedExecutions, 0)
	stats.Set(numQueuedExecutionsOK, 0)
	stats.Set(numQueuedExecutionsFailed, 0)
	stats.Set(numQueuedExecutionsWait, 0)
	stats.Set(numQueuedStatementsRx, 0)
	stats.Set(numQueuedStatementsTx, 0)
	stats.Set(numQueries, 0)
	stats.Set(numRemoteExecutions, 0)
	stats.Set(numRemoteQueries, 0)
	stats.Set(numRemoteBackups, 0)
	stats.Set(numRemoteLoads, 0)
	stats.Set(numRemoteRemoveNode, 0)
	stats.Set(numReadyz, 0)
	stats.Set(numStatus, 0)
	stats.Set(numBackups, 0)
	stats.Set(numLoad, 0)
	stats.Set(numJoins, 0)
	stats.Set(numNotifies, 0)
	stats.Set(numAuthOK, 0)
	stats.Set(numAuthFail, 0)
}
