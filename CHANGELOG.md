...
- [PR #2670](https://github.com/rqlite/rqlite/pull/2670): Correctly pass `nil` Credential Store to the HTTP service. See [issue #2669](https://github.com/rqlite/rqlite/discussions/2669).
