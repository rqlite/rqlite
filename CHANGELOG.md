## 5.0.0 (unreleased)
_To upgrade from an earlier version to this release you should backup the database under your leader node, and replay the resultant database dump into a new 5.0 leader node. Check out [BACKUP.md](https://github.com/rqlite/rqlite/blob/master/DOC/BACKUPS.md) for more details._
