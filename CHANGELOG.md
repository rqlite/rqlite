...
### New features
- [PR #2469](https://github.com/rqlite/rqlite/pull/2469): Add `db/sql` API to demonstrate SQL rewriting. See [docs](https://rqlite.io/docs/api/non-deterministic/) for more details.
