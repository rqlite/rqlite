## 8.23.0 (unreleased)
Upgrading to this release can be performed via a rolling restart if necessary. However until all nodes in a cluster are running 8.23.0, writes to the cluster **may** return an error. Queries should operate without issue at all times however.
### New features
