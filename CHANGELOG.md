...
- [PR #2533](https://github.com/rqlite/rqlite/pull/2533): Fix code in `db` package which return errors, but was actually returning `nil`. Fixes issue [#2530](https://github.com/rqlite/rqlite/issues/2530).
