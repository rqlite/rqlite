...
- [PR #1140](https://github.com/rqlite/rqlite/pull/1140): Use SQLite with corrected in-memory database locking. Fixes [issue #1103](https://github.com/rqlite/rqlite/issues/1103).
