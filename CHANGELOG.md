...
- [PR #1541](https://github.com/rqlite/rqlite/pull/1541): DNS-based autoclustering supports read-only (non-voting) nodes. Fixes issue [#1521](https://github.com/rqlite/rqlite/issues/1521)
