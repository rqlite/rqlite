...
You can check the current state of foreign key constraints at anytime via the [status API](https://github.com/rqlite/rqlite/blob/master/DOC/DIAGNOSTICS.md), or by issuing the SQL query `PRAGMA foreign_keys`.
