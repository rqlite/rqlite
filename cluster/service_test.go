...
func Test_NewServiceSetGetNodeAPIAddrPooled(t *testing.T) {
	ml := mustNewMockPooledTransport()
	s := New(ml)
	if s == nil {
		t.Fatalf("failed to create cluster service")
	}
...
func mustNewMockTransport() Transport {
...
func mustNewMockTLSTransport() Transport {
...
func mustNewMockPooledTransport() Transport {
	return NewPooledTransport(mustNewMockTransport())
}
