...
const (
	...
	Command_COMMAND_TYPE_BROADCAST     Command_Type = 13
)
...
func (x *Command) GetBroadcastRequest() *BroadcastRequest {
	if x != nil {
		if x, ok := x.Request.(*Command_BroadcastRequest); ok {
...
type Command_BroadcastRequest struct {
	BroadcastRequest *BroadcastRequest `protobuf:"bytes,13,opt,name=broadcast_request,json=broadcastRequest,proto3,oneof"`
}
...
func (*Command_BroadcastRequest) isCommand_Request() {}
...
func (x *BroadcastRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
const file_message_proto_rawDesc = "" +
	...
	"\aversion\x18\x03 \x01(\tR\aversion\"\xf0\t\n" +
	"\aCommand\x12)\n" +
	...
	"\x11broadcast_request\x18\r \x01(\v2\x19.cluster.BroadcastRequestH\x00R\x10broadcastRequest\x126\n" +
	"\vcredentials\x18\x04 \x01(\v2\x14.cluster.CredentialsR\vcredentials\"\xfe\x02\n" +
	"\x04Type\x12\x18\n" +
	...
	"\x15COMMAND_TYPE_STEPDOWN\x10\f\x12\x1a\n" +
	"\x16COMMAND_TYPE_BROADCAST\x10\rB\t\n" +
	"\arequest\"\x87\x01\n" +
...
var file_message_proto_goTypes = []any{
	...
	(*BroadcastRequest)(nil),           // 14: cluster.BroadcastRequest
	(*BroadcastResponse)(nil),          // 15: cluster.BroadcastResponse
...
var file_message_proto_depIdxs = []int32{
	...
	14, // 11: cluster.Command.broadcast_request:type_name -> cluster.BroadcastRequest
